                                ...
                                <div class="main-menu">
                                    <nav class="d-none d-lg-block">
                                        <ul id="navigation">
                                            ...
                                            ?>
                                            <li><a href="{{URL::to('/employer')}}">Nhà tuyển dụng</a>
                                            <ul class="submenu">
                                                <li><a href="{{URL::to('/employer-edit')}}">Cập nhật thông tin</a></li>
                                                <li><a href="{{URL::to('/employer')}}">Các tin đã đăng</a></li>
                                                <li><a href="{{URL::to('/employer-logout')}}">Đăng xuất</a></li>
                                            </ul>
                                            </li><?php } 
                                        ?>
                                 ...
                                 <div id="mc_embed_signup">
                                     ...
                                     method="get" class="subscribe_form relative mail_part">
                                         ...
                                         <div class="form-icon">
                                             ...
                                             class="email_icon newsletter-submit button-contactForm"><img src="{{asset('public/frontend/assets/img/icon/form.png')}}" alt=""></button>
                                         </div>

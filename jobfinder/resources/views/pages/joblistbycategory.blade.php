                    ...
                    <div class="col-9 mx-auto">
                        ...
                        <section class="featured-job-area">
                            <div class="container">
                                ...
                                $count_category = DB::table('job')->where('category_id',$category_id)->where('job_status',1)->whereDay('job_closeday', '>=', \Carbon\Carbon::today())->count();
                                @endphp
                                
                                            <span>{{$count_category}} công việc </span>
